...
\input{sections/01_paper_overview}

\input{sections/02_background_and_problem}

\input{sections/03_method}

\input{sections/04_architecture_and_hyperparams}

\input{sections/05_evaluation_and_results}

\input{sections/06_limitations_and_open_questions}

\part{The code}

\input{sections/07_repo_layout}

\input{sections/08_algorithm_walkthrough}

\input{sections/09_benchmark_harness}

\input{sections/10_reproduction_pipeline}

\appendix

\input{sections/A_glossary}

\input{sections/B_notation}
