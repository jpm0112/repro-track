...
\subsection{Inference: \file{pred.py}}
...
\subsection{LongBench scoring: \file{eval.py}}
...
\subsection{$\infty$-Bench scoring: \file{infinitebench\_eval.py}}
...
\subsection{Shared metric primitives: \file{metrics.py}}
...
\subsection{Data preparation: \file{download.py}}
