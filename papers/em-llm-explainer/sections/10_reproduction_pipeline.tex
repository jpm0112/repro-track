...
\subsection{Environment files: \file{reproduction/scripts/env/}}
\label{sec:repro-env}
...
\subsection{Shell wrappers: \file{reproduction/scripts/shell/}}
...
\paragraph{\file{\_paper\_variants.sh}.} A sourced library that maps model names to paper-faithful variant tags. The table below summarises its content; the script itself is in \file{reproduction/scripts/shell/\_paper\_variants.sh}.
...
\subsection{ASA-X payloads: \file{reproduction/scripts/asax/}}
...
\subsection{Outputs and analysis: \file{reproduction/results/}, \file{reproduction/analysis/}}
