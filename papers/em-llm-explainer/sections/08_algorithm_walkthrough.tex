...
\subsection{The attention forward: \file{attention/em\_llm.py}}
...
\subsection{The context manager: \file{attention/context\_manager.py}}
...
\subsection{Similarity refinement: \file{attention/similarity\_refinement/}}
...
\subsection{Multi-stage dot-product attention: \file{attention/dot\_product\_attention/}}
...
\subsection{Rotary embeddings: \file{attention/rope.py}}
...
\subsection{The Hugging Face patch: \file{utils/patch\_hf.py}}
...
\subsection{Generation: \file{utils/greedy\_search.py}}
